  ...
  return (
	<div className="about-container row flex-lg-row align-items-center g-5" style={{marginTop:"-90px", maxWidth:"1400px"}}>
		...
		<div class="about-details col-lg-6 d-flex flex-column justify-center align-items-center">
			...
			<br/>
			<p class="" style={{marginBottom: "50px", marginRight: "0px"}}>All beads are kiln fired for lifetime durability. Jewelry made with longterm use sterling silver & bronze metalware. <br/>Custom designs and sets available.</p>		
